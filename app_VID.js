...
peer.on('call', call => {
    ...
    call.on('stream', Remote_Stream => {
        ...
        receiverDataConnection = peer.connect(callerId);
    });
});
...
function SpeechRecognition(Source_Language, Target_Language) {
    ...
    recognition.onstart = () => {
        Translate_Button.classList.add('recognizing');
    };

    recognition.onend = () => {
        Translate_Button.classList.remove('recognizing');
    };
    ...
    fetch(url, {
        ...
        body: JSON.stringify(request),
            ...
            .then(data => {
                ...
                } else if (receiverDataConnection && receiverDataConnection.open) {
                    receiverDataConnection.send(translatedText);
                }
            })
            .catch(error => {
